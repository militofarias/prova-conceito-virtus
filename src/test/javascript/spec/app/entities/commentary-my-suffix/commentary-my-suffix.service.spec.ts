...
describe('Service Tests', () => {
    ...
    describe('CommentaryMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CommentaryMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/commentaries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CommentaryMySuffix', () => {
