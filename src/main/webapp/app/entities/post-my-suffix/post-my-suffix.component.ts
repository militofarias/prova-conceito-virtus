...
@Component({
    selector: 'jhi-post-my-suffix',
    templateUrl: './post-my-suffix.component.html'
})
export class PostMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.postService.search({
                ...
                (res: HttpResponse<PostMySuffix[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: PostMySuffix) {
        return item.id;
    }
